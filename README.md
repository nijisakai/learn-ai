...
* [**第一章 物联网与传感器**](#第一章-物联网与传感器)
	* [第一节 使用esp8266在网页上读取传感器数据，绘制实时变化曲线（待调整）](#第一节-使用esp8266在网页上读取传感器数据绘制实时变化曲线待调整)
		* [**学习流程**](#学习流程)
			* [课程引入 （15分钟）](#课程引入-15分钟)
			* [基本任务 （30分钟）](#基本任务-30分钟)
			* [活动总结 （10分钟）](#活动总结-10分钟)
		...
		* [**背景知识（PPT）**](#背景知识ppt)
			* [物联网背景知识](#物联网背景知识)
			* [如何使用开发板读取传感器数据](#如何使用开发板读取传感器数据)
		* [**硬件准备（PPT）**](#硬件准备ppt)
			* [硬件清单](#硬件清单)
			* [硬件连接](#硬件连接)
		* [**程序及操作（PPT）**](#程序及操作ppt)
			* [操作步骤-简单读取](#操作步骤-简单读取)
			* [操作步骤-绘制实时变化曲线](#操作步骤-绘制实时变化曲线)
			* [代码详解](#代码详解)
	...
	* [第四节 esp32网络摄像头与人脸识别](#第四节-esp32网络摄像头与人脸识别)
		* [**学习流程**](#学习流程-3)
			* [课程引入 （15分钟）](#课程引入-15分钟-3)
			* [基本任务 （35分钟）](#基本任务-35分钟-2)
			* [活动总结 （10分钟）](#活动总结-10分钟-3)
		* [**活动目标**](#活动目标-2)
		* [**背景知识**](#背景知识-2)
			* [A](#a)
			* [B](#b)
...
### 第一节 使用esp8266在网页上读取传感器数据，绘制实时变化曲线（待调整）
