...
* [**第1章 人工智能体验**](#第1章-人工智能体验)
	...
	* [第7节 人工智能与游戏](#第7节-人工智能与游戏)
		* [7.1 训练一个简单的游戏AI（Deep Q Network）](#71-训练一个简单的游戏aideep-q-network)
			* [**硬件准备**](#硬件准备-3)
			* [**程序及操作**](#程序及操作-4)
		* [7.2 使用进化算法来训练超级马里奥](#72-使用进化算法来训练超级马里奥)
			* [**硬件准备**](#硬件准备-4)
			* [**程序及操作**](#程序及操作-5)
* [**第2章 物联网与传感器**](#第2章-物联网与传感器)
	...
	* [第2节 WiFi遥控小车](#第2节-wifi遥控小车)
		...
		* [**背景知识**](#背景知识-1)
			* [**电机**](#电机)
			* [**SP12E Motor Shield**](#sp12e-motor-shield)
		* [**硬件准备**](#硬件准备-6)
			* [硬件清单](#硬件清单-1)
			* [硬件连接](#硬件连接-1)
		* [**程序及操作**](#程序及操作-7)
	...
	* [第3节 机械臂](#第4节-机械臂)
		* [**demo**](#demo-2)
		* [**学习流程**](#学习流程-3)
			* [课程引入 （15分钟）](#课程引入活动目标-1-15分钟)
			* [基本任务 （35分钟）](#基本任务硬件准备-1-35分钟)
			* [活动小结 （10分钟）](#活动小结活动小结-1-10分钟)
		* [**活动目标**](#活动目标-3)
		* [**背景知识**](#背景知识-3)
			* [舵机](#舵机)
			* [舵机的工作原理](#舵机的工作原理)
		...
		* [**程序及操作**](#程序及操作-9)
			...
			* [相关代码](#相关代码-3)
		* [**活动小结**](#活动小结-3)  
	* [第4节 自动避障小车](#第3节-自动避障小车)
		* [**demo**](#demo-1)
		* [**学习流程**](#学习流程-2)
			* [课程引入 （10分钟）](#课程引入活动目标-1-10分钟-1)
			* [基本任务 （30分钟）](#基本任务硬件准备-1-30分钟-1)
			* [活动小结 （5分钟）](#活动小结活动小结-1-5分钟-1)
		* [**活动目标**](#活动目标-2)
		* [**背景知识**](#背景知识-2)
			* [**超声波传感器**](#超声波传感器)
		* [**硬件准备**](#硬件准备-7)
...
#### 7.1 训练一个简单的游戏AI（Deep Q Network）
...
<center><iframe src="http://hass.live:900X" width="800" height="300" scrolling="no" frameborder="0" mozallowfullscreen webkitallowfullscreen allowfullscreen></iframe></center>
...
### 第2节 Home Assistant控制esp8266彩色灯
