...
* [**前导**](#前导)
	...
	* [开源（嵌入式）硬件概述](#开源嵌入式硬件概述)
			* [开源（嵌入式）硬件的发展](#开源嵌入式硬件的发展)
			* [流行的开源（嵌入式）硬件](#流行的开源嵌入式硬件)
...
* [其他](#其他)
* [**第一章 物联网与传感器**](#第一章-物联网与传感器)
	* [第一节 传感器的读取与曲线绘制](#第一节-传感器的读取与曲线绘制)
		* [**学习流程**](#学习流程)
			* [课程引入 （10分钟）](#课程引入活动目标-10分钟)
			* [基本任务 （30分钟）](#基本任务硬件准备-30分钟)
		...
		* [**程序及操作**](#程序及操作)
			...
			* [相关代码](#相关代码)
		* [**活动小结**](#活动小结)
	* [第二节 WiFi遥控小车](#第二节-wifi遥控小车)
		* [**demo**](#demo)
		* [**学习流程**](#学习流程-1)
			* [课程引入 （10分钟）](#课程引入活动目标-1-10分钟)
			* [基本任务 （30分钟）](#基本任务硬件准备-1-30分钟)
		...
		* [**程序及操作**](#程序及操作-1)
			...
			* [相关代码](#相关代码-1)
		* [**活动小结**](#活动小结-1)
	* [第三节 WiFi机械臂](#第三节-wifi机械臂)
		* [**demo**](#demo-1)
		* [**学习流程**](#学习流程-2)
			* [课程引入 （10分钟）](#课程引入活动目标-2-10分钟)
			* [基本任务 （30分钟）](#基本任务硬件准备-2-30分钟)
			* [活动小结 （5分钟）](#活动小结活动小结-2-5分钟)
		* [**活动目标**](#活动目标-2)
		* [**背景知识**](#背景知识-2)
			* [舵机](#舵机)
			* [舵机的工作原理](#舵机的工作原理)
		...
		* [**程序及操作**](#程序及操作-2)
			...
			* [相关代码](#相关代码-2)
		* [**活动小结**](#活动小结-2)
	* [第四节 DIY网络摄像头与人脸识别](#第四节-diy网络摄像头与人脸识别)
		* [**学习流程**](#学习流程-3)
			* [课程引入 （10分钟）](#课程引入活动目标-3-10分钟)
			* [基本任务 （30分钟）](#基本任务硬件准备-3-30分钟)
	...
	* [第五节 综合与进阶](#第五节-综合与进阶)
		...
		* [**功能参考**](#功能参考)
	* [尾声](#尾声)
* [**第二章 物联网创意应用**](#第二章-物联网创意应用)
	* [第一节 Home Assistant安装和配置](#第一节-home-assistant安装和配置)
		* [**硬件准备**](#硬件准备-4)
			* [硬件清单](#硬件清单-4)
			* [硬件连接](#硬件连接-4)
		* [**程序及操作**](#程序及操作-4)
			* [安装过程](#安装过程)
	* [第二节 Home Assistant控制esp8266彩色灯](#第二节-home-assistant控制esp8266彩色灯)
		* [**硬件准备**](#硬件准备-5)
		* [**程序及操作**](#程序及操作-5)
	* [第三节 Home Assistant人脸解锁](#第三节-home-assistant人脸解锁)
		* [**硬件准备**](#硬件准备-6)
		* [**程序及操作**](#程序及操作-6)
* [**第三章 物联网机器人小绿**](#第三章-物联网机器人小绿)
	* [第一节 组装一个小绿机器人](#第一节-组装一个小绿机器人)
		* [**硬件准备**](#硬件准备-7)
		* [**程序及操作**](#程序及操作-7)
	* [第二节 训练语音识别，开始和小绿聊天](#第二节-训练语音识别开始和小绿聊天)
		* [**硬件准备**](#硬件准备-8)
		* [**程序及操作**](#程序及操作-8)
	* [第三节 让小绿听你指挥，控制一切](#第三节-让小绿听你指挥控制一切)
		* [**硬件准备**](#硬件准备-9)
		* [**程序及操作**](#程序及操作-9)
	* [第四节 使用Google Blockly来控制小绿](#第四节-使用google-blockly来控制小绿)
		* [**硬件准备**](#硬件准备-10)
		* [**程序及操作**](#程序及操作-10)
	* [第五节 使用OpenPose让小绿实时模仿你的动作](#第五节-使用openpose让小绿实时模仿你的动作)
		* [**硬件准备**](#硬件准备-11)
		* [**程序及操作**](#程序及操作-11)
* [**第四章 人工智能算法相关案例体验**](#第四章-人工智能算法相关案例体验)
	* [第一节 Tensorflow训练自定义图片分类器](#第一节-tensorflow训练自定义图片分类器)
		* [**硬件准备**](#硬件准备-12)
		* [**程序及操作**](#程序及操作-12)
	* [第二节 使用RNN来生成古诗词](#第二节-使用rnn来生成古诗词)
		* [**硬件准备**](#硬件准备-13)
		* [**程序及操作**](#程序及操作-13)
	* [第三节 训练一个简单的游戏AI（Deep Q Network）](#第三节-训练一个简单的游戏aideep-q-network)
		* [**硬件准备**](#硬件准备-14)
		* [**程序及操作**](#程序及操作-14)
	* [第四节 使用进化算法来训练超级马里奥](#第四节-使用进化算法来训练超级马里奥)
		* [**硬件准备**](#硬件准备-15)
		* [**程序及操作**](#程序及操作-15)
	* [第五节 基于opencv在raspberry 上的人脸识别操作](#第五节-基于opencv在raspberry-上的人脸识别操作)
		* [**硬件准备**](#硬件准备-16)
		* [**环境准备**](#环境准备-1)
		* [**程序及操作**](#程序及操作-16)
	* [第六节 Neural Style 图像风格迁移](#第六节-neural-style-图像风格迁移)
		* [**准备**](#准备)
			* [VGG 网络](#vgg-网络)
			* [环境准备](#环境准备-2)
		* [**程序及操作**](#程序及操作-17)
* [**第五章 自动避障小车**](#第五章-自动避障小车)
	* [第一节 环境准备与硬件搭建](#第一节-环境准备与硬件搭建)
		* [**硬件准备**](#硬件准备-17)
		* [**程序及操作**](#程序及操作-18)
	* [第二节 通过超声波传感器进行避障](#第二节-通过超声波传感器进行避障)
		* [**硬件准备**](#硬件准备-18)
		* [**程序及操作**](#程序及操作-19)
* [**第六章 自动追踪小车**](#第六章-自动追踪小车)
	* [第一节 环境准备与硬件搭建](#第一节-环境准备与硬件搭建-1)
		* [**硬件准备**](#硬件准备-19)
		* [**程序及操作**](#程序及操作-20)
	* [第二节 OpenCV机械臂自动抓取特定形状物体](#第二节-opencv机械臂自动抓取特定形状物体)
		* [**硬件准备**](#硬件准备-20)
		* [**程序及操作**](#程序及操作-21)
	* [第三节 OpenCV分类器训练，让小车追踪特定物体](#第三节-opencv分类器训练让小车追踪特定物体)
		* [**硬件准备**](#硬件准备-21)
		* [**程序及操作**](#程序及操作-22)
* [**第七章 无人驾驶小车**](#第七章-无人驾驶小车)
	* [第一节 环境准备与硬件搭建](#第一节-环境准备与硬件搭建-2)
		* [**硬件准备**](#硬件准备-22)
			* [硬件清单](#硬件清单-5)
			* [硬件连接](#硬件连接-5)
		* [**程序及操作**](#程序及操作-23)
			* [操作步骤](#操作步骤-3)
	* [第二节 电机和摄像头驱动测试](#第二节-电机和摄像头驱动测试)
		* [**程序及操作**](#程序及操作-24)
			* [操作步骤-电机测试](#操作步骤-电机测试)
			* [操作步骤-摄像头测试](#操作步骤-摄像头测试)
	* [第三节 无人驾驶数据采集及训练](#第三节-无人驾驶数据采集及训练)
		* [**硬件准备**](#硬件准备-23)
			* [硬件清单](#硬件清单-6)
			* [硬件搭建-跑道](#硬件搭建-跑道)
		* [**程序及操作**](#程序及操作-25)
...
1.打开`learn-ai`文件夹，打开路径`codes/chapter1/esp8266_projects/esp8266_dht11_http`  
...
7.连接另一个esp8266开发板，打开路径`codes/chapter1/esp8266_projects/esp8266_ultrasonic_http`,再次执行2-6步骤来使用超声波传感器  

##### 绘制实时曲线

1.打开`learn-ai`文件夹，打开路径`codes/chapter1/esp8266_projects/esp8266_dht11_http_chartjs`  
2.将esp8266通过数据线连接到电脑  
...
1. 打开`learn-ai`文件夹，打开路径`codes/chapter1/esp8266_projects/esp8266_servoarm_http`  
2. 将esp8266通过数据线连接到电脑
...
1.打开`learn-ai`文件夹，打开路径`codes/chapter1/esp32_projects/esp32_webcam`  
...
### 第二节 Home Assistant控制esp8266彩色灯
...
### 第三节 训练一个简单的游戏AI（Deep Q Network）
...
### 第五节 基于opencv在raspberry 上的人脸识别操作
