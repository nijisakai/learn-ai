...
esp8266是一个具有WiFi功能的开发板，它是由一家名为乐鑫的科技公司所设计，在由安信可科技公司负责生产，在以前要买到具有WiFi功能的开发板都要上千元，esp8266打破了这个价钱，一个只需要65元左右，65元的开发板功能应有尽有，不输上百元的开发板，因此esp8266很受开发连网相关应用的开发者的喜爱。
