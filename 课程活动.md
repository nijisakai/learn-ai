...
1. 打开`ai`文件夹，打开路径`chapter 1/part 1/esp8266 projects/esp8266_dht11_http`
...
7. 连接另一个esp8266开发板，打开路径`chapter 1/part 1/esp8266 projects/esp8266_ultrasonic_http`,再次执行2-6步骤来使用超声波传感器。
...
1. 打开`ai`文件夹，打开路径`chapter 1/part 1/esp8266 projects/esp8266_wificar_http`
2. 将esp8266通过数据线连接到电脑
...
1. 打开`ai`文件夹，打开路径`chapter 1/part 1/esp8266 projects/esp8266_servoarm_http`
2. 将esp8266通过数据线连接到电脑
