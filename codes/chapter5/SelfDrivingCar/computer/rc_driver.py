        ...
        try:
            ...
            while True:
                ...
                if first != -1 and last != -1:
                    ...
                    v_param3 = self.obj_detection.detect(self.my_cascade, gray, image)

                    # distance measurement
                    if v_param1 > 0 or v_param2 > 0 or v_param3:
                        d1 = self.d_to_camera.calculate(v_param1, self.h1, 300, image)
                        d2 = self.d_to_camera.calculate(v_param2, self.h2, 100, image)
                        d3 = self.d_to_camera.calculate(v_param3, self.h1, 100, image)
                        self.d_stop_sign = d1
                        self.d_light = d2
                        self.d_my = d3
                    ...
                    elif 0 < self.d_my < 25 and stop_sign_active:
                        print("my object ahead")
                        self.rc_car.stop()
