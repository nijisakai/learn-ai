...
![alt embeded-sys](http://home.hass.live/md-embeded-sys.jpg)
...
![alt arm-linux](http://home.hass.live/md-arm-linux.jpg)  
...
![alt linux-nfs](http://home.hass.live/md-linux-nfs.jpg)
...
![alt rpi-ssh](http://home.hass.live/md-rpi-ssh.jpg)

1. xrdp:是Linux平台上的远程桌面的一种，通过在系统中开启此软件(服务)，就可以通过Windows操作系统中的“远程桌面”应用程序访问目标计算机的桌面，如下图所示：
![alt mstsc](http://home.hass.live/md-mstsc.jpg)

如上图所示，在局域网中，只需在 “计算机” 文本框中填入目标计算机的IP地址，即可访问到远程计算机的桌面。  
若远程桌面访问起来比较卡顿，可通过修改“显示选项”来改善：  
   1. 修改显示分辨率  
   ![alt mstsc-fbl](http://home.hass.live/md-mstsc-net.png)

   1. 修改网络传输类型  
   ![alt mstsc-net](http://home.hass.live/md-mstsc-set.png)

1. VNC：是第三方公司开发的远程桌面访问软件，树莓派官方系统直接对VNC服务端做了系统整合；只需在局域网的PC端安装“VNC Viewer”，即可通过此PC访问目标计算机在局域网中的IP地址来开启远程桌面。如下图所示：  

   ![alt vnc-viewer](http://home.hass.live/md-vnc-viewer.png)


### Python环境基本操作
![alt python](http://home.hass.live/md-python.jpg)
...
树莓派上运行python2环境，如下图：
![alt python2](http://home.hass.live/md-python2.png)


树莓派上运行python3环境，如下图：
![alt python3](http://home.hass.live/md-python3.png)
